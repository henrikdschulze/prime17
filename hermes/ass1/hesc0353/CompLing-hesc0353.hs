...
test3 = TestCase $ assertEqual "initialPairs" [("a","b")] (initialPairs [["a","b","a"],["c"]])

test4 = TestCase $ assertEqual "finalPairs" [("b","a")] (finalPairs [["a","b","a"],["c"]])

-- small example with 4 words
-- pairsCount
test5 = TestCase $ assertBool "pairsCount simple" 
            (elem (("a","b"), 2) (pairsCount [("a","b"),("c","d"),("a","b")]))
test6 = TestCase $ assertBool "pairsCount tricky" 
             (let x = pairsCount (adjacentPairs [["a","b","a"],["c"]]) in 
                      elem (("a","b"), 2) x || elem (("b","a"), 2) x)

-- neighbours
test7 = TestCase $ assertEqual "neighbours left" [("b",2)] 
                                                 (neighbours [(("a","b"),2),(("c","d"),1)] "a")

test8 = TestCase $ assertEqual "neighbours right" [("a",2)]
                                                 (neighbours [(("a","b"),2),(("c","d"),1)] "b")
runtests0_8 = runTestTT $ TestList [test0,test1,test2,test3,test4,test5,test6,test7,test8]

-- mostCommonNeighbour
test9 = TestCase $ assertEqual "mostCommonNeighbour text \"the\"" (Just "fun")
                                                                  (mostCommonNeighbour input "the")
  where input = [(("the", "fun"),4),(("the","foot"),3),(("dog","power"),2)]

test10 = TestCase $ assertEqual "mostCommonNeighbour text \"spam\""
                      Nothing (mostCommonNeighbour input "spam")
  where input = [(("the", "fun"),4),(("the","foot"),3),(("dog","power"),2)]

-- testing the PandP.austin text
test11 = TestCase $ assertEqual "mostCommonNeighbour of \"bennet\""
            (Just "mr") (mostCommonNeighbour (pairsCount $ adjacentPairs $ austin) "bennet")
runtest11 = runTestTT $ TestList [test11]

-- testing the PandP.austin text
test12 = TestCase $ assertEqual "mostCommonNeighbour of \"fruitless\""
            (Nothing) (mostCommonNeighbour (pairsCount $ adjacentPairs $ austin) "fruitless")
runtest12 = runTestTT $ TestList [test12]
...
runtest1221 = runTestTT $ TestList [test12,test21]

-- for running all the tests (type "runtests0_9" within ghci --- without the quotes)
runtests = runTestTT $ TestList [test0,test1,test2,test3,test4,test5,test6,test7,test8,test9,test10,test11]

--  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =  =
-- :set +s
-- pairsCount $ adjacentPairs austin
-- pairsCount $ adjacentPairs umbertoeco
